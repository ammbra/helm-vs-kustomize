...
*/}}
{{- define "todo-app-frontend.chart" -}}
...
helm.sh/chart: {{ include "todo-app-frontend.chart" . }}
...
app.kubernetes.io/name: {{ include "todo-app-frontend.name" . }}
...
{{- default (include "todo-app-frontend.fullname" .) .Values.serviceAccount.name }}
{{- else }}
