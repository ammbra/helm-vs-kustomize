...
helm.sh/chart: {{ include "todo-app-backend.chart" . }}
...
app.kubernetes.io/name: {{ include "todo-app-backend.name" . }}
...
{{- default (include "todo-app-backend.fullname" .) .Values.serviceAccount.name }}
{{- else }}
